...
var configDefault = {
  ...
  cognito: {
    ...
    // e.g. poolId: 'eu-west-1:deadbeef-cac0-babe-abcd-abcdef01234',
    poolId: ''
  },
...
var Loader = function Loader() {
  ...
  var credentials = new CognitoConstructor({ IdentityPoolId: mergedConfig.cognito.poolId }, { region: mergedConfig.region || 'eu-west-1' });

  var awsConfig = new AWSConfigConstructor({
    region: mergedConfig.region || 'eu-west-1',
